"""Fail-closed final evidence publication for registered Experiment 006.
...
from falsewake import experiment_006_final_evidence as _completed_evidence
...
__all__ = (
    ...
    "Experiment006FinalPublicationError",
    "FailureCode",
    "FailurePhase",
...
_REPORT_PATH: Final = "reports/experiment-006-training.json"
...
_RERUN_HISTORY_PATH: Final = "reports/experiment-006-selected-rerun-history.json"
_MODEL_PATH: Final = "models/experiment-006-selected.safetensors"
...
_TEMP_PREFIX: Final = ".falsewake-exp006-publication-"
...
class Experiment006FinalPublicationError(ValueError):
...
def _fail(message: str) -> NoReturn:
    raise Experiment006FinalPublicationError(message)
...
def _failure_report_bytes(
    ...
    return (
        '{"artifacts":[],"checkpoint_reusable":false,"experiment":"006",'
...
def _make_failure_evidence_routes() -> tuple[
    ...
    error_type = Experiment006FinalPublicationError
...
def _parse_canonical_report(raw: bytes) -> dict[str, Any]:
    ...
    try:
        ...
        raise Experiment006FinalPublicationError(
