"""One-shot production worker for one registered Experiment 003 seed.
...
class Experiment003SeedWorkerError(RuntimeError):
...
def _require_registered_assignment(
    ...
    *,
    ...
    _error_type: type[Experiment003SeedWorkerError] = Experiment003SeedWorkerError,
...
def _make_registered_seed_process() -> Callable[
    ...
    worker_error = Experiment003SeedWorkerError
    exact_type = type
