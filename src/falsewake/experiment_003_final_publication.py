"""Fail-closed final evidence publication for registered Experiment 003.
...
from falsewake import experiment_003_final_evidence as _completed_evidence
from falsewake import experiment_003_run_authority as _run_authority
...
__all__ = (
    ...
    "Experiment003FinalPublicationError",
    "FailureCode",
    "FailurePhase",
...
_REPORT_PATH: Final = "reports/experiment-003-training.json"
...
_RERUN_HISTORY_PATH: Final = "reports/experiment-003-selected-rerun-history.json"
_MODEL_PATH: Final = "models/experiment-003-selected.safetensors"
...
_TEMP_PREFIX: Final = ".falsewake-exp003-publication-"
_EXPERIMENT: Final = "003"
_SCIENTIFIC_PROTOCOL: Final = "002"
_PREDECESSOR_IMPLEMENTATION_COMMIT: Final = "21bbcc56e898beb44edc8e3ff775fa9642f87577"
_PREDECESSOR_INCIDENT_COMMIT: Final = "650eefbf9f82b207ed58e3b1a1eac41197466b41"
_PREDECESSOR_INCIDENT_SHA256: Final = (
    "353e33acc156e6e3a598d3dd777afbe5b15125b1b24f7f48266859f09f297b59"
)
_PREDECESSOR_OUTCOME_COMMIT: Final = "289372957565c093076cb476c84fa900a9cc4cce"
_PREDECESSOR_OUTCOME_SHA256: Final = (
    "494336d12e47f7bce952251e4c079770920f57032354e9618050250ee32bb99a"
)
_PREDECESSOR_REGISTRATION_COMMIT: Final = "f5d27175496279cf6ee1538f9bae950527cf5db4"
...
_PREDECESSOR_CANONICAL_JSON: Final = (
    '{"experiment":"002",'
    f'"implementation_commit":"{_PREDECESSOR_IMPLEMENTATION_COMMIT}",'
    f'"incident":{{"commit":"{_PREDECESSOR_INCIDENT_COMMIT}",'
    '"path":"reports/experiment-002-execution-incident.json",'
    f'"sha256":"{_PREDECESSOR_INCIDENT_SHA256}"}},'
    f'"outcome":{{"checkpoint_reusable":false,"code":"seed_selection_failed",'
    f'"commit":"{_PREDECESSOR_OUTCOME_COMMIT}",'
    '"path":"reports/experiment-002-training.json",'
    '"phase":"registered_execution",'
    f'"sha256":"{_PREDECESSOR_OUTCOME_SHA256}",'
    '"status":"execution_failure"},'
    f'"registration":{{"commit":"{_PREDECESSOR_REGISTRATION_COMMIT}",'
    '"path":"configs/experiment-002-run.json",'
    f'"sha256":"{_PREDECESSOR_REGISTRATION_SHA256}",'
    f'"source_bundle_sha256":"{_PREDECESSOR_SOURCE_BUNDLE_SHA256}"}},'
...
class Experiment003FinalPublicationError(ValueError):
...
def _fail(message: str) -> NoReturn:
    raise Experiment003FinalPublicationError(message)
...
def _predecessor_document() -> dict[str, object]:
    return {
        ...
        "outcome": {
            ...
            "commit": _PREDECESSOR_OUTCOME_COMMIT,
            "path": "reports/experiment-002-training.json",
            "phase": "registered_execution",
            "sha256": _PREDECESSOR_OUTCOME_SHA256,
            "status": "execution_failure",
        },
        "registration": {
...
def _failure_report_bytes(
    ...
    return (
        '{"artifacts":[],"checkpoint_reusable":false,"experiment":"003",'
...
def _make_failure_evidence_routes() -> tuple[
    ...
    error_type = Experiment003FinalPublicationError
...
def _parse_canonical_report(raw: bytes) -> dict[str, Any]:
    ...
    try:
        ...
        raise Experiment003FinalPublicationError(
...
def _make_registered_publisher() -> Callable[[VerifiedRunRegistration, object], None]:
    ...
    constant_names = (
        ...
        "_PREDECESSOR_OUTCOME_COMMIT",
        "_PREDECESSOR_OUTCOME_SHA256",
