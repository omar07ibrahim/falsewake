"""One-shot production worker for one registered Experiment 005 seed.
...
from falsewake.experiment_005_coordinator import (
    REGISTERED_SEEDS,
...
class Experiment005SeedWorkerError(RuntimeError):
...
def _require_registered_assignment(
    ...
    *,
    ...
    _error_type: type[Experiment005SeedWorkerError] = Experiment005SeedWorkerError,
...
def _make_registered_seed_process() -> Callable[
    ...
    worker_error = Experiment005SeedWorkerError
    exact_type = type
