"""One-shot production worker for one registered Experiment 002 seed.
...
from falsewake.experiment_002_coordinator import (
    REGISTERED_SEEDS,
...
class Experiment002SeedWorkerError(RuntimeError):
...
def _require_registered_assignment(
    ...
    *,
    ...
    _error_type: type[Experiment002SeedWorkerError] = Experiment002SeedWorkerError,
...
def _make_registered_seed_process() -> Callable[
    ...
    worker_error = Experiment002SeedWorkerError
    exact_type = type
