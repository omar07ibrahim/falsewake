"""One-shot production worker for one registered Experiment 004 seed.
...
class Experiment004SeedWorkerError(RuntimeError):
...
def _require_registered_assignment(
    ...
    *,
    ...
    _error_type: type[Experiment004SeedWorkerError] = Experiment004SeedWorkerError,
...
def _make_registered_seed_process() -> Callable[
    ...
    worker_error = Experiment004SeedWorkerError
    exact_type = type
