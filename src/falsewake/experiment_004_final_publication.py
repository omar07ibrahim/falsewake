"""Fail-closed final evidence publication for registered Experiment 004.
...
from falsewake import experiment_004_final_evidence as _completed_evidence
from falsewake import experiment_004_run_authority as _run_authority
...
__all__ = (
    ...
    "Experiment004FinalPublicationError",
    "FailureCode",
    "FailurePhase",
...
_REPORT_PATH: Final = "reports/experiment-004-training.json"
...
_RERUN_HISTORY_PATH: Final = "reports/experiment-004-selected-rerun-history.json"
_MODEL_PATH: Final = "models/experiment-004-selected.safetensors"
...
_TEMP_PREFIX: Final = ".falsewake-exp004-publication-"
_EXPERIMENT: Final = "004"
...
_PREDECESSOR_IMPLEMENTATION_COMMIT: Final = "4475461d5fd3e5b8969020003424c73bb10d3c9b"
_PREDECESSOR_RUNTIME_FINGERPRINT_SHA256: Final = (
    "c167d636026909879c952858c67c304ce5a1bbb981284242c3d6235efe205f8f"
)
_PREDECESSOR_SOURCE_BUNDLE_SHA256: Final = (
    "28094defd76ba395a5b4eec477b6f0516686013df5995f24c3c126a35b09c0b6"
)
_PREDECESSOR_INCIDENT_COMMIT: Final = "96f151d86ae060b402a0ef5d47de7ad8c1191c0a"
_PREDECESSOR_INCIDENT_SHA256: Final = (
    "0dc24fd211129cd2b81e29fb91ac9e66a0aad25f1deeae332f3b6ea420567688"
)
_PREDECESSOR_REGISTRATION_COMMIT: Final = "f7426fb038ae5dc0c24b5141d12d55323ac7c961"
_PREDECESSOR_REGISTRATION_SHA256: Final = (
    "941a4ec67d2adbe0149861a678fc19e46ac4e2188c126b64c4b9c54f01425b2c"
)
_PREDECESSOR_CANONICAL_JSON: Final = (
    '{"execution_protocol":{"introduction_commit":"'
    f'{_PREDECESSOR_EXECUTION_PROTOCOL_COMMIT}"'
    ',"path":"configs/experiment-003-execution.json","sha256":"'
    f'{_PREDECESSOR_EXECUTION_PROTOCOL_SHA256}"'
    '},"experiment":"003","implementation":{"commit":"'
    f'{_PREDECESSOR_IMPLEMENTATION_COMMIT}"'
    ',"runtime_fingerprint_sha256":"'
    f'{_PREDECESSOR_RUNTIME_FINGERPRINT_SHA256}"'
    ',"source_bundle_sha256":"'
    f'{_PREDECESSOR_SOURCE_BUNDLE_SHA256}"'
    '},"incident":{"commit":"'
    f'{_PREDECESSOR_INCIDENT_COMMIT}"'
    ',"path":"reports/experiment-003-execution-incident.json","sha256":"'
    f'{_PREDECESSOR_INCIDENT_SHA256}"'
    '},"outcome":{"automatic_terminal_report_published":false,'
    '"checkpoint_reusable":false,"code":"parent_route_signature_mismatch",'
    '"phase":"registered_admission","status":"execution_failure"},'
    '"registration":{"commit":"'
    f'{_PREDECESSOR_REGISTRATION_COMMIT}"'
    ',"path":"configs/experiment-003-run.json","sha256":"'
    f'{_PREDECESSOR_REGISTRATION_SHA256}"'
    ',"source_bundle_sha256":"'
    f'{_PREDECESSOR_SOURCE_BUNDLE_SHA256}"'
    '},"reuse_forbidden":true,"scientific_protocol":"002","terminal":true,'
    '"topology":{"incident_commit":"'
    f'{_PREDECESSOR_INCIDENT_COMMIT}"'
    ',"incident_parent":"'
    f'{_PREDECESSOR_REGISTRATION_COMMIT}"'
    ',"outcome_report_path":"reports/experiment-003-training.json",'
    '"outcome_report_present":false,"registration_commit":"'
    f'{_PREDECESSOR_REGISTRATION_COMMIT}"'
    ',"registration_parent":"'
    f'{_PREDECESSOR_IMPLEMENTATION_COMMIT}"'
    "}}"
...
class Experiment004FinalPublicationError(ValueError):
...
def _fail(message: str) -> NoReturn:
    raise Experiment004FinalPublicationError(message)
...
def _predecessor_document() -> dict[str, object]:
    return {
        ...
        "implementation": {
            ...
            "runtime_fingerprint_sha256": (_PREDECESSOR_RUNTIME_FINGERPRINT_SHA256),
            "source_bundle_sha256": _PREDECESSOR_SOURCE_BUNDLE_SHA256,
        },
        "incident": {
        ...
        "registration": {
            "commit": _PREDECESSOR_REGISTRATION_COMMIT,
            "path": "configs/experiment-003-run.json",
            "sha256": _PREDECESSOR_REGISTRATION_SHA256,
            "source_bundle_sha256": _PREDECESSOR_SOURCE_BUNDLE_SHA256,
        },
        ...
        "topology": {
            ...
            "incident_parent": _PREDECESSOR_REGISTRATION_COMMIT,
            "outcome_report_path": "reports/experiment-003-training.json",
            "outcome_report_present": False,
            "registration_commit": _PREDECESSOR_REGISTRATION_COMMIT,
            "registration_parent": _PREDECESSOR_IMPLEMENTATION_COMMIT,
        },
    }
...
def _failure_report_bytes(
    ...
    return (
        '{"artifacts":[],"checkpoint_reusable":false,"experiment":"004",'
...
def _make_failure_evidence_routes() -> tuple[
    ...
    error_type = Experiment004FinalPublicationError
...
def _parse_canonical_report(raw: bytes) -> dict[str, Any]:
    ...
    try:
        ...
        raise Experiment004FinalPublicationError(
