...
CANDIDATE_PATH = ROOT / "src/falsewake/experiment_004_supervisor.py"
...
def test_supervisor_is_exact_protocol_normalized_parity() -> None:
    ...
    assert "Experiment 004" in candidate_text
    assert "falsewake-experiment-004-scratch" in candidate_text
    assert "falsewake-experiment-004-staging" in candidate_text
    assert "falsewake-exp004-child-activation" in candidate_text
